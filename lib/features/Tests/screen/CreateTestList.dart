                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(onTap: () => Get.off(()=>Testpage(batchName: widget.batchName, weekNumber: week.weekNumber, topic: week.topic)),child: ongoingtest(week.weekNumber,week.topic));
                      },
                    ),
                  ],
                );
