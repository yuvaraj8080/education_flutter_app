            ...
            child: Padding(padding: const EdgeInsets.all(20),
                child: Column(
                    children: [
                              ...
                              children: [
                                Obx(() {
                                  ...
                                  return controller.imageUploading.value
                                      ...
                                      width: 100,
                                      height: 100,
                                      isNetworkImage: user.isNotEmpty
                                          ? true
                                          : false);
                                }),
                                ...
                                OutlinedButton(onPressed: () =>
                                    ...
                                    child: Text(
                                        "Change Profile Picture", style: Theme
                                        .of(context)
                                        .textTheme
                                        .titleSmall))
                              ])
                      ...
                      const TSectionHeading(title: "Profile Inforamation",
                          showActionButton: false),
                      const SizedBox(height: 8),

                      Obx(() {
                        return TProfileMenu(title: "Name",
                            value: controller.user.value.fullName,
                            onPressed: () {});
                      }),
                      Obx(() {
                        return TProfileMenu(title: "StudentID",
                      ...
                      Obx(() {
                        return TProfileMenu(title: "Batch",
                            value: controller.user.value.batch,
                            icon: Iconsax.copy,
                            onPressed: () {});
                      }),
                      Obx(() {
                        return TProfileMenu(title: "E-Mail",
                            value: controller.user.value.email,
                            onPressed: () {});
                      }),
                      Obx(() {
                        return TProfileMenu(title: "Mobile",
